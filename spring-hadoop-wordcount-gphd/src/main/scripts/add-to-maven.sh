...
mvn install:install-file -Dfile=$PIVOTAL_INSTAL_DIR/gphd/hadoop-mapreduce-2.0.2_alpha_gphd_2_0_1_0/hadoop-mapreduce-examples-2.0.2-alpha-gphd-2.0.1.0.jar -DgroupId=gphd     -DartifactId=gphd-examples -Dversion=2.0.1.0 -Dpackaging=jar
nvn install:install-file -Dfile=$PIVOTAL_INSTAL_DIR/hadoop-yarn-2.0.2_alpha_gphd_2_0_1_0/hadoop-yarn-api-2.0.2-alpha-gphd-2.0.1.0.jar -DgroupId=gphd     -DartifactId=gphd-yarn-api -Dversion=2.0.1.0 -Dpackaging=jar
mvn install:install-file -Dfile=$PIVOTAL_INSTAL_DIR/hadoop-yarn-2.0.2_alpha_gphd_2_0_1_0/hadoop-yarn-common-2.0.2-alpha-gphd-2.0.1.0.jar -DgroupId=gphd     -DartifactId=gphd-yarn-client -Dversion=2.0.1.0 -Dpackaging=jar
